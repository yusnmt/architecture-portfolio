  ...
  return (
    <div className='ap__research section__padding' id='research'>
      <div className='ap__research-heading'>
        ...
        <p>建築設計におけるデザインという創造的な行為は、人への依存が高い行為、さらには機械による代替が難しいと考えられる分野である。一方で「創造性」を意図した、人工知能の研究が進んでいる。特に訓練データを学習し、実在しないデータを生成することや訓練データの特徴に沿った新しいデータを作り出すことができる敵対的生成ネットワークGANは、デザイン分野において大きな可能性を持つと考えられる。本研究ではGANを用いた創造性を持つ人工知能、つまり建築設計・デザイン分野への応用を意図したCreative AIを作成し、Creative AIと設計者が共に作り上げていく設計プロセスを提案する。</p>
      </div>
